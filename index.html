...
<body>
  ...
  <!--
    Un-Ordered List of Contanct Info
  -->
  <ul>
    <li><strong>Email:</strong><a href="#">samuelschlunsen@gmail.com</a></li>
    <li><strong>GitHub:</strong><a href="#">SamuelSchlunsen</a></li>
    <li><strong>Twitter:</strong><a href ="#">SamuelSchlunsen</a></li>
  </ul>
...
<a href = "C:\Users\samue\SS_ALL_MY_REPOS\HTML PRAC">My First HTML Page</a>
</body>
